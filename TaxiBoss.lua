-- // Taxi Boss Script by Arracheur2_92i
...
local colors = {
    ...
    Color3.fromRGB(0, 255, 128), Color3.fromRGB(255, 20, 147), Color3.fromRGB(64, 224, 208),
}
...
InterfaceManager:SetFolder("Arracheur2Hub")
SaveManager:SetFolder("Arracheur2Hub/TaxiBoss")
...
Fluent:Notify({
    ...
    Content = "Script by Arracheur2_92i",
    Duration = 5
})
